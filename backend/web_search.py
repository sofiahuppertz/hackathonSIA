...
# collectivite = "Nice"
# queries = [
#     {"search_query": f"Historique des réorganisations de {collectivite} des 20 dernières années"},
# ]
...
# # Instantiate the Section model and SearchQuery list
...
# async def test_section_graph():
#     # Invoke the graph asynchronously using the initial_state
#     output = await section_builder_graph.ainvoke(initial_state)
#     # Print the completed sections returned by the graph
#     for sec in output["completed_sections"]:
#         print("Section Name:", sec.name)
#         print("Section Content:\n", sec.content)
#         print("-----")

# # Run the test
# asyncio.run(test_section_graph())